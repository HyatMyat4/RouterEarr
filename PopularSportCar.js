...
function PopularSportCar({ 
  title , price , Type , Engin , Torque , Horsepower , Acceleration ,Transmission , TopSpeed ,Special , person , image , href
}) {
    ...
    return (      
      <div className="PopularSportCar">
        <div className="Popular-Container">
           ...
           <i class="fa-solid fa-heart love-heart "></i><span className="count-Love">1328</span> 
            <i class="fa-solid fa-star Star "></i><span className="count-star">1328</span>             
            </div>                  
            </div>
